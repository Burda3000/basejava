...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.getSections().put(SectionType.EXPERIENCE, new OrganizationSection(Arrays.asList(new Organisation(LocalDate.of(2013, Month.OCTOBER, 1), LocalDate.of(2020, Month.JANUARY, 14),
                        "Java Online Projects", "www.javaops.ru", "Автор проекта", "Создание, организация " +
                ...
                new Organisation(LocalDate.of(2014, Month.OCTOBER, 1), LocalDate.of(2016, Month.JANUARY, 1),
                        "Wrike", "www.Wrike.ru", "Старший разработчик (backend)", "Проектирование и разработка " +
                ...
                new Organisation(LocalDate.of(2012, Month.APRIL, 1), LocalDate.of(2014, Month.OCTOBER, 1),
                        "RIT Center", null, "Java архитектор", "Организация процесса разработки системы ERP " +
                ...
                new Organisation(LocalDate.of(2010, Month.DECEMBER, 1), LocalDate.of(2012, Month.APRIL, 1),
                        "Luxoft (Deutsche Bank)", "www.Luxoft.ru", "Ведущий программист", "Участие в проекте " +
                ...
                new Organisation(LocalDate.of(2008, Month.MARCH, 1), LocalDate.of(2010, Month.DECEMBER, 1),
                        "Yota", "www.Yota.ru", "Ведущий специалист", "Дизайн и имплементация Java EE фреймворка " +
                ...
                new Organisation(LocalDate.of(2007, Month.MARCH, 1), LocalDate.of(2008, Month.JUNE, 1),
                        "Enkata", "www.Enkata.ru", "Разработчик ПО", "Реализация клиентской (Eclipse RCP) и " +
                ...
                new Organisation(LocalDate.of(2005, Month.JANUARY, 1), LocalDate.of(2007, Month.FEBRUARY, 1),
                        "Siemens AG", "www.Siemens.com", "Разработчик ПО", "Разработка информационной модели, " +
                ...
                new Organisation(LocalDate.of(1997, Month.SEPTEMBER, 1), LocalDate.of(2005, Month.JANUARY, 1),
                        "Alcatel", "www.Alcatel.com", "Инженер по аппаратному и программному тестированию",
